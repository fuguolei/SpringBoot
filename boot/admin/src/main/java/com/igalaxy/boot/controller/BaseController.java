...
public class BaseController {
    ...
    protected String writeErrorResult(HttpServletResponse response, int code, String msg) {
        BaseResult1 result = new BaseResult1(false, code, msg);
    ...
    protected String writeSuccessResult(HttpServletResponse response, String msg) {
        BaseResult1 result = new BaseResult1(true, 0, msg);
        HttpUtil.writeJson(response, AppJsonUtils.toJson(result, null));
        return null;
    }

    protected String writeSuccessResult(HttpServletResponse response, BaseDomain data) {
        BaseResult1 result = new BaseResult1(true, data);
        HttpUtil.writeJson(response, AppJsonUtils.toJson(result, null));
        return null;
    }

    protected String writeResult(HttpServletResponse response, BaseResult1 result) {
        HttpUtil.writeJson(response, AppJsonUtils.toJson(result, null));
        return null;
    }

    protected String writeResult(HttpServletResponse response, BaseResult1 result, String[] field) {
