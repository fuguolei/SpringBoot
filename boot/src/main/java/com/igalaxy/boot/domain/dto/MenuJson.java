...
public class MenuJson {
    ...
    public static List<MenuJson> convertMemuList(List<SysResource> resList) {
        return getMemuListByParentId(null, resList);
    }

    private static List<MenuJson> getMemuListByParentId(Long parentId, List<SysResource> resList) {
